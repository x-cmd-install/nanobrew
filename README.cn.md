...
[![x-cmd/install — nanobrew Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/nanobrew.svg?lang=zh)](https://x-cmd.com/install/nanobrew)
...
合计: **82,451** 行代码（覆盖前 5 种语言、共 **146** 个文件）。
...
- **官网**: <https://nanobrew.trilok.ai>
- **许可证**: Apache-2.0

## 发布

- **最新版本**: `monterey-intel-pilot-35267015112` (2026-09-16)
- **最近提交**: 2026-09-16
- **Release 含资产**: 10 个

## 流行度

- **Star**: 1,123 · **Fork**: 19 · **开放 issue**: 221 · **贡献者**: 6

## 累计统计

- **发布数**: 56 · **已合并 PR**: 131 · **开放 PR**: 4 · **已关闭 issue**: 218 · **开放 issue**: 3 · **提交数**: 636

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-27 | 12 | 18 | 4 | 4 | 3 | 26 |
| last60d | 2026-07-28 | 15 | 24 | 4 | 10 | 3 | 42 |
| 90d | 2026-06-28 | 19 | 26 | 4 | 26 | 3 | 57 |
| last180d | 2026-03-30 | 33 | 112 | 4 | 150 | 3 | 317 |
| 360d | 2025-10-01 | 56 | 131 | 4 | 218 | 3 | 516 |
| last720d | 2024-10-06 | 56 | 131 | 4 | 218 | 3 | 636 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/nanobrew.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260926.yml` · 2026-09-26T04:56:41Z._
